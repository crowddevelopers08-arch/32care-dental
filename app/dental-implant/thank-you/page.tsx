...
>>>>>>> be88ed746ea3784c93f336e8a72ed33b849f3293
      ...
      <main className="min-h-screen bg-[#f3f9fd] font-['Onest',sans-serif] text-[#092b4c]">
        ...
        <section className="relative isolate flex min-h-[calc(100vh-76px)] items-center overflow-hidden px-4 py-12 sm:px-7 lg:px-12">
          ...
          <div className="mx-auto w-full max-w-[760px] rounded-[28px] border border-[#d5e8f3] bg-white px-6 py-10 text-center shadow-[0_20px_60px_rgba(7,53,118,.12)] sm:px-12 sm:py-14">
            ...
            <p className="mt-7 text-[12px] font-extrabold tracking-[.16em] text-[#0067ac] uppercase">Dental implant request received</p>
            <h1 className="mt-2 text-[32px] leading-tight font-extrabold sm:text-[42px]">Thank You For Your Consultation Request!</h1>
            <p className="mx-auto mt-5 max-w-[570px] text-[16px] leading-[1.7] text-[#38536b] sm:text-[17px]">Your dental implant consultation request has been received. Our implant care team will contact you shortly to understand your concern and help schedule your clinical evaluation.</p>
            ...
            <Link href="/dental-implant" className="mt-8 inline-flex min-h-14 items-center justify-center rounded-full bg-[#0067ac] px-8 text-[14px] font-extrabold text-white transition hover:-translate-y-0.5 hover:bg-[#073576]">Back to Dental Implant Page</Link>
          </div>
        </section>
        <PageFooter />
        <MobileActionBar />
