...
import { PageHeader } from "@/components/dentalimplants/PageHeader";
import { PageFooter } from "@/components/dentalimplants/PageFooter";

export const metadata: Metadata = {
  title: "Dental Implant Privacy Policy | 32Care Dental Clinic Pune",
  description: "Privacy policy for dental implant consultation enquiries submitted to 32Care Dental Clinic in Pune.",
};

const sections = [
  ["Information We Collect", "When you submit the dental implant consultation form, we collect your name, phone number, selected implant concern, the page URL, and technical submission details. This form does not request your email address."],
  ["How We Use Your Information", "We use this information to respond to your dental implant enquiry, arrange a consultation, understand your treatment concern, and provide relevant information about implant assessment and treatment planning."],
  ...
  ["Your Choices", "You may ask us to update, correct, or delete the enquiry information we hold about you, subject to applicable legal and clinical record requirements."],
      ...
      <section className="px-4 py-11 sm:px-7 sm:py-16 lg:px-12">
        <div className="mx-auto max-w-[900px]">
          <header className="rounded-[24px] bg-[linear-gradient(118deg,#2d78bb_0%,#086cae_54%,#083a75_100%)] px-6 py-10 text-center text-white sm:px-12 sm:py-14">
            <p className="text-[12px] font-extrabold tracking-[.16em] text-[#8fe0ff] uppercase">Dental Implant Care · 32Care Dental Clinic</p>
            <h1 className="mt-2 text-[32px] font-extrabold sm:text-[42px]">Dental Implant Privacy Policy</h1>
          ...
          <article className="mt-6 rounded-[24px] border border-[#d5e8f3] bg-white px-6 py-8 shadow-[0_16px_42px_rgba(7,53,118,.08)] sm:px-10 sm:py-11">
            <p className="text-[15px] leading-[1.75] text-[#38536b]">32Care Dental Clinic respects your privacy. This policy explains how we collect, use, and protect information submitted through our dental implant consultation form.</p>
