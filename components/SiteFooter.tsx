...
export function SiteFooter() {
  return (
    <footer className="relative bg-[#102532] px-5 pt-12 font-['Onest',sans-serif] text-white sm:px-8 lg:px-12">
        ...
        <div className="grid items-center gap-8 pb-6 md:grid-cols-[1fr_1.6fr_1fr]">
          ...
          <form className="flex items-center gap-5 max-[620px]:block" action="#">
            ...
            <div className="flex h-14 min-w-0 flex-1 overflow-hidden rounded-[5px] bg-white">
              ...
              <button type="submit" aria-label="Subscribe" className="grid w-[72px] shrink-0 place-items-center bg-[#0876b5] text-white transition hover:bg-[#54b6ec]">
      ...
      <a href="#" aria-label="Back to top" className="absolute right-7 bottom-7 grid h-13 w-13 place-items-center rounded-full bg-[#0876b5] text-[27px] text-white  transition hover:-translate-y-1 hover:bg-[#54b6ec]">↑</a>
    </footer>
  );
}
