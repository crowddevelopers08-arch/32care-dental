  ...
  return (
    <div className="fixed inset-x-0  bottom-1 z-50 rounded-full border-t border-[#073576]/15 bg-white/95 p-1 shadow-[0_-6px_20px_rgba(7,53,118,0.14)] backdrop-blur lg:hidden">
      <div className="mx-auto grid max-w-[620px] grid-cols-2 gap-3">
        ...
        <button type="button" onClick={scrollToForm} className="flex h-12 cursor-pointer items-center justify-center gap-2 rounded-full bg-[#0067ac] text-[14px] font-extrabold text-white shadow-sm transition active:scale-[0.98]">
          Book Now
          <ArrowIcon />
        </button>
      </div>
