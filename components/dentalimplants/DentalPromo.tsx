...
const features = [
  {
    ...
    description: "Patients with missing teeth and suitable oral health conditions may be considered for dental implants after evaluation.",
  },
  {
    title: "Are dental implants painful?",
    description: "Dental implant procedures are performed using professional dental techniques focused on patient comfort.",
  },
  {
    title: "How long does dental implant treatment take?",
    description: "Treatment duration depends on individual factors such as oral health, medical health, healing time, and the number of implants required.",
  },
  {
    title: "How long do dental implants last?",
    description: "With proper care, regular dental visits, and good oral hygiene, implants can provide long-term tooth replacement.",
  },
  {
    title: "What is the cost of dental implants in Pune?",
    description: "The cost depends on factors like implant type, number of teeth replaced, and individual treatment requirements.",
  },
  {
    title: "Are dental implants better than dentures?",
    description: "Dental implants provide a fixed solution and may offer improved stability compared to traditional removable dentures.",
  },
  {
    title: "Can multiple missing teeth be replaced with implants?",
    description: "Yes, multiple implants or implant-supported solutions can replace several missing teeth.",
  },
  {
    title: "Is bone grafting required before implants?",
    description: "Some patients may require bone grafting depending on jawbone condition.",
  },
  {
    title: "How should I care for dental implants?",
    description: "Maintain regular brushing, flossing, and dental check-ups for better implant health.",
  },
  {
    title: "Are dental implants safe?",
    description: "Dental implants are a widely used tooth replacement option when planned by qualified dental professionals.",
  },
];
    ...
    <section id="faqs" className="relative overflow-hidden border-y border-[#e4eef5] bg-[linear-gradient(118deg,#2d78bb_0%,#086cae_54%,#083a75_100%)] px-5 py-12 font-['Onest',sans-serif] text-white sm:px-8 lg:px-12 lg:py-16">
      ...
      <div className="relative mx-auto grid max-w-[1360px] items-center gap-14 max-[620px]:gap-6 lg:grid-cols-[730px_1fr] lg:gap-24">
        ...
        <div className="order-1 max-[620px]:contents">
          <Reveal direction="right" className="min-w-0 max-[620px]:order-1"><SectionLabel light align="start">Frequently Asked Questions</SectionLabel></Reveal>
          <Reveal delay={80} direction="left" className="min-w-0 max-[620px]:order-2"><h2 className="mt-2 lg:mt-2 lg:mb-5 max-w-[700px] text-[30px] leading-[1.22] tracking-[-.6px] text-white max-[620px]:mt-0 max-[620px]:text-[23px]">Questions Patients Commonly Ask About <span color="#8fe0ff" className="font-bold text-[#8fe0ff]">Dental Implants</span></h2></Reveal>
          ...
          <Reveal delay={200} className="max-[620px]:order-6 max-[620px]:mt-0">
            <a href="#consultation-form" data-open-consultation-modal className="group relative mt-10 inline-flex min-h-[54px] items-center justify-center overflow-hidden rounded-full border-2 border-white px-8 text-center text-[14px] font-bold text-white transition-all duration-300 hover:-translate-y-1 max-[620px]:mt-0 max-[620px]:w-full max-[620px]:px-3 max-[620px]:text-[12px]">
              ...
              <span className="relative z-10 max-[620px]:hidden transition-colors duration-500 group-hover:text-[#073576]">Book Your Dental Implant Consultation Today</span>
